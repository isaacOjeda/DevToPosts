...
public class TavilySearchTool
{
    ...
    [Description("Searches the public web for technical documentation, articles, benchmarks, papers, news, and authoritative sources on any topic.")]
    public async Task<string> SearchWebAsync(
        [Description("The targeted search query, e.g. 'Microsoft Agent Framework Harness architecture C#'")]
        string query,
        CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            {
                formattedResults.AppendLine($"Direct Summary: {result.Answer}\n");
            }
